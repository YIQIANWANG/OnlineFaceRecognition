 ...
 */
package com.chenframework.common.baiduai.client;

import com.chenframework.common.baiduai.auth.CloudAuth;
import com.chenframework.common.baiduai.auth.DevAuth;
import com.chenframework.common.baiduai.error.AipError;
import com.chenframework.common.baiduai.http.AipHttpClient;
import com.chenframework.common.baiduai.http.AipRequest;
import com.chenframework.common.baiduai.http.AipResponse;
import com.chenframework.common.baiduai.http.Headers;
import com.chenframework.common.baiduai.http.HttpContentType;
import com.chenframework.common.baiduai.http.HttpMethodName;
import com.chenframework.common.baiduai.util.AipClientConfiguration;
import com.chenframework.common.baiduai.util.AipClientConst;
import com.chenframework.common.baiduai.util.SignUtil;
...
//        }
    ...
    /*
     * 需要重新获取access_token的条件： 1. 是DEV用户，即 isBceKey为false 2. isAuthorized为false，或isAuthorized为true，但当前时间晚于expireDate前一天
     */
    ...
    /*
     * 为公有云用户填充http header，传入的request中body&param已经ready 对于DEV用户，则将access_token放到url中
     */
