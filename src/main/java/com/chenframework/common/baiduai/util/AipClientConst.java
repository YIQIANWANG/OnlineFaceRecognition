 ...
 */
package com.chenframework.common.baiduai.util;
...
public class AipClientConst {
    ...
    public static final HashSet<String> BCE_HEADER_TO_SIGN = new HashSet<String>(
            Arrays.asList("host", "content-md5", "content-length", "content-type"));
